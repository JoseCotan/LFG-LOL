    ...
    return (
        ...
        <div className="max-w-4xl mx-auto p-8">
            <form onSubmit={handleSubmit}>
                <div className="mb-6">
                    <label htmlFor="nombre" className="block mb-2 text-sm font-medium text-white dark:text-gray-300">Nombre del Rango</label>
                ...
                <div className="mb-6">
                    <label htmlFor="imagen" className="block mb-2 text-sm font-medium text-white dark:text-gray-300">Imagen del Rango</label>
